...
public class MockInstanceTerminationUnknownTest extends AbstractCloudbreakIntegrationTest {
    ...
    public void configMockServer(@Optional("9443") int mockPort, @Optional("2020") int sshPort) {
        ...
        InstanceTerminationUnknownMock instanceTerminationMock = (InstanceTerminationUnknownMock)
                applicationContext.getBean(InstanceTerminationUnknownMock.NAME, mockPort, sshPort, numberOfServers);
    ...
    public void breakDown() {
        MockServer instanceTerminationMock = getItContext().getContextParam(CloudbreakV2Constants.MOCK_SERVER, InstanceTerminationUnknownMock.class);
